...
namespace Dicom.Imaging.LUT
{
    public class VOISequenceLUT : ILUT
    {
        ...
        public void Recalculate()
        {
            ...
            var LUTDataElement = _renderOptions.VOILUTSequence.Items[0].Get<DicomElement>(DicomTag.LUTData);
        ...
        {
            var lutDescriptorElement = _renderOptions.VOILUTSequence.Items[0].Get<DicomElement>(DicomTag.LUTDescriptor);
